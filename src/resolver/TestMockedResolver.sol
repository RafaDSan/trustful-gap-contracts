...
contract TestMockedResolver is Resolver {
  ...
  function attestMockedReview(Attestation calldata /*attestation*/) internal pure returns (bool) {
    return true;
  }

  function attestMockedGrant(Attestation calldata /*attestation*/) internal pure returns (bool) {
    return true;
  }
